...
resource "google_cloudbuild_trigger" "export-dlp-inspect-trigger" {
  project = var.gcp_project_id
  name = "export-dlp-inspect"
  description = "Export DLP inspect configuration to GIT"
  source_to_build {
    ...
    step {
      ...
      args = [
                      ...
                      <<-EOT
                        ...
                        python3 ./export_dlp-inspect.py -s $BRANCH_NAME -c $$CFG -f /workspace/$$GRIZZLY_REPO
                      EOT
      ]
    }
  }
