...
resource "google_cloudbuild_trigger" "export-datacatalog-trigger" {
  project = var.gcp_project_id
  name = "export-datacatalog"
  description = "Export DataCatalog templates to GIT."
  source_to_build {
    ...
    step {
      ...
      args = [
                      ...
                      <<-EOT
                        ...
                        python3 ./export_data-catalog.py -s $BRANCH_NAME -c $$CFG -f /workspace/$$GRIZZLY_REPO
                      EOT
      ]
    }
  }
