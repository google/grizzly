...
resource "google_cloudbuild_trigger" "export-dlp-deidentify-trigger" {
  project = var.gcp_project_id
  name = "export-dlp-deidentify"
  description = "Export DLP deidentify configuration to GIT"
  source_to_build {
    ...
    step {
      ...
      args = [
                      ...
                      <<-EOT
                        ...
                        python3 ./export_dlp-deidentify.py -s $BRANCH_NAME -c $$CFG -f /workspace/$$GRIZZLY_REPO
                      EOT
      ]
    }
  }
