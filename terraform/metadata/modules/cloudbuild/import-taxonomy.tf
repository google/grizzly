...
resource "google_cloudbuild_trigger" "import-taxonomy-trigger" {
  project = var.gcp_project_id
  name = "import-taxonomy"
  description = "Import Taxonomy into BQ table"
  substitutions = {
  }
  source_to_build {
    ...
    step {
      ...
      args = [
                      ...
                      <<-EOT
                          ...
                          python3 ./import_taxonomy.py -e $BRANCH_NAME -c $$CFG -f /workspace/$$GRIZZLY_REPO
                        EOT
      ]
    }
  }
